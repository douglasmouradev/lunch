-- Titanium Lunch — Script de instalação completo
-- Execute: mysql -u root -p < setup/install.sql

CREATE DATABASE IF NOT EXISTS titanium_lunch CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- Admin padrão: usuário admin / senha titanium2024
INSERT INTO admin_users (username, password_hash)
VALUES ('admin', '$2y$12$y2fqSFnJ75lR76eTpEJBneFXg4.3LjW/CHnOYC.XgdYFP0e961ct6')
ON DUPLICATE KEY UPDATE username = VALUES(username);

-- Colaboradores: importe com php setup/sync-employees.php ou pelo admin (Excel/JSON)
